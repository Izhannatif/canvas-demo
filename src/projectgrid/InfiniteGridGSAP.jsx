...
const InfiniteGridGSAP = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="w-full h-screen bg-black overflow-hidden relative cursor-grab"
...
const GridItem = ({
  ...
  return (
    <>
      <div
        ref={itemRef}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-y border-white bg-white" // Center the item
