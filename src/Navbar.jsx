...
//                       to="/"
//                       onClick={() => setIsNavbarOpen(false)}
//                       className="w-full h-full flex items-end justify-end px-5 py-3 bg-black text-white"
//                     >
//                       <span className="text-2xl cal">home.</span>
//                     </Link>
//                   }
...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        ref={overlayRef}
        className="fixed top-0 left-0 w-full h-full bg-white/70 z-40 backdrop-blur-3xl"
        style={{ opacity: 0, pointerEvents: "none" }}
      ></div>
