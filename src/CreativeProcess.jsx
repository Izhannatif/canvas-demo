...
export default function CreativeProcess() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-screen min-w-screen bg-black overflow-hidden -mt-[50vh]"
    >
      <div ref={contentRef} className="w-full h-full origin-center">
        ...
        <div
          ref={mainHeadingRef}
          className="absolute top-2/6 text-center w-full text-stone-900/30 text-[12vw] md:text-[13vw] leading-none mix-blend-screen"
        >
          creative process
        </div>
      </div>
